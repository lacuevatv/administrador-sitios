...
CREATE TABLE `noticias` (
  ...
  `post_link_externo` varchar(250) NOT NULL DEFAULT '',
  `post_fecha_agenda` date DEFAULT NULL,
...
--
ALTER TABLE `noticias`
  MODIFY `post_ID` int(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `options`
--
ALTER TABLE `options`
  MODIFY `OPTIONS_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
